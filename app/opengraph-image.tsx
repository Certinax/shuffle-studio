...
export const alt = "Shuffle Studio green shuffle icon on a dark gradient background";
export const size = {
  width: 1200,
  height: 630,
};
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7L15.3 5.7C16.1 4.6 17.3 4 18.6 4H22" />
                  <path d="M2 6h1.4c1.3 0 2.5.6 3.3 1.7l1.2 1.5" />
                  <path d="m14.1 14.8 1.2 1.5c.8 1.1 2 1.7 3.3 1.7H22" />
                </svg>
              </div>
              Shuffle Studio
            </div>
